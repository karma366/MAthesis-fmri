...
anatImage = spm_vol('C:\Users\Karla\Dropbox\Research projects\MA Thesis\data\november preprocessed\sub01\wSUB01_anat.nii');
...
while 1
   ...
   if butn == 115   %'s' == 'save file'
        ...
        [fileName, pathName] = uiputfile('', 'ROI_SPL_left')
