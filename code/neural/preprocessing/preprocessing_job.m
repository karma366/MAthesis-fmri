%-----------------------------------------------------------------------
% Job script for running the preprocessing.
% Works only with adequately set up master script, from which it should be
% run. Check *_master.m file for master script.
