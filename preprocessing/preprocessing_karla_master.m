%%%%% PREPROCESSING (Realign; Slice timing; Coregister; Old Normalise;
%%%%% Smooth; Old Normalise - anatomical)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

nSub = 15; % Enter the number of subjects here
nRun = 8; % Enter the number of runs/sessions per subject here
nInputs = 12; % Enter the number of missing inputs per batch here
...
SubjectID = {01 02 03 04 06 07 08 09 10 11 12 14 15 16 17 18}; % Enter the identifiers for all subjects

% Location of the batch created in SPM GUI
